;;; verilog3-mode.el --- Major mode for SystemVerilog -*- lexical-binding: t -*-

;; Author: Harish Nagisetty
;; Keywords: verilog, indentation

;;; Commentary:

;; I wrote verilog3-mode because verilog-mode indentation wasn't very
;; consistent for me. I started with modifying verilog-mode, but realized that
;; since all I wanted was indentation, it was better to write my own from
;; scratch.

;; This mode indents large files better. For example, it took 11.3 seconds to
;; indent one large file with verilog-mode and just 2.8 seconds with
;; verilog3-mode.

;; Font Lock is copied from verilog-mode.

;; Some indentation functions were copied from smie-mode (Simple Minded
;; Indentation Engine).
